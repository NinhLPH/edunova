...
import { LogOut, Users, BookOpen, BarChart3, TrendingDown, Video, ClipboardMinus } from 'lucide-react';
      ...
      <div className="content animate-fade-in">
        ...
        {hasExamData ? (
          <h2 style={{ fontSize: '1.2rem', fontWeight: 'bold', marginBottom: '16px', display: 'flex', alignItems: 'center', gap: '8px' }}>
            <BarChart3 /> Báo cáo: {exam?.title || 'Tổng quan'}
          </h2>
        ) : (
          <h2 style={{ fontSize: '1.2rem', fontWeight: 'bold', marginBottom: '16px', display: 'flex', alignItems: 'center', gap: '8px' }}>
            <BarChart3 /> Báo cáo: Chưa có bài kiểm tra nào được thực hiện
          </h2>
        )}
